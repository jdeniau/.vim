...
endfun
" }}}
call <SID>X("Boolean","dad085","","none")
...
call <SID>X("Comment","5f5a60","","italic")
call <SID>X("Conditional","e2e4e5","","none")
call <SID>X("Constant","cf6a4c","","none")
call <SID>X("Cursor","f8f8f8","586068","none")
call <SID>X("CursorColumn","e2e4e5","182028","none")
call <SID>X("CursorLine","e2e4e5","182028","none")
...
call <SID>X("DiffAdd","f8f8f8","","none")
call <SID>X("DiffChange","f8f8f8","","none")
call <SID>X("DiffDelete","f8f8f8","","none")
call <SID>X("DiffText","cf6a4c","","none")
...
call <SID>X("ErrorMsg","f8f8f8","","none")
call <SID>X("Exception","f8f8f8","","none")
call <SID>X("Float","e2e4e5","","none")
call <SID>X("FoldColumn","e2e4e5","","none")
call <SID>X("Folded","a0a8b0","384048","none")
call <SID>X("Function","dad085","","none")
call <SID>X("Identifier","7587a6","","none")
call <SID>X("Ignore","e2e4e5","","none")
call <SID>X("IncSearch","e2e4e5","","none")
call <SID>X("Include","cda869","","none")
call <SID>X("Keyword","f8f8f8","","none")
call <SID>X("Label","e2e4e5","","none")
call <SID>X("LineNr","808080","141414","italic")
call <SID>X("LocalVariable","e2e4e5","","none")
call <SID>X("Macro","cda869","","none")
call <SID>X("MatchParen","ffffff","80a090","none")
call <SID>X("ModeMsg","f8f8f8","","none")
call <SID>X("MoreMsg","e2e4e5","","none")
call <SID>X("NonText","808080","303030","none")
call <SID>X("Normal","f8f8f8","141414","none")
call <SID>X("Number","cf6a4c","","none")
call <SID>X("Operator","f8f8f8","","none")
call <SID>X("PMenu","ffffff","808080","none")
call <SID>X("PMenuSbar","ffffff","141414","none")
call <SID>X("PMenuSel","f0f0f0","4f4a50","none")
call <SID>X("PMenuThumb","ffffff","808080","none")
call <SID>X("PreCondit","cda869","","none")
call <SID>X("PreProc","cda869","","none")
call <SID>X("Question","f8f8f8","","none")
call <SID>X("Repeat","e2e4e5","","none")
call <SID>X("Search","e2e4e5","","none")
call <SID>X("SignColumn","e2e4e5","","none")
call <SID>X("Special","f8f8f8","","none")
...
call <SID>X("Statement","dad085","","none")
call <SID>X("StatusLine","f0f0f0","4f4a50","italic")
call <SID>X("StatusLineNC","c0c0c0","5f5a60","italic")
call <SID>X("StorageClass","e2e4e5","","none")
call <SID>X("String","ddf2a4","","none")
call <SID>X("Structure","9b859d","","none")
...
call <SID>X("Title","f8f8f8","","none")
call <SID>X("Todo","808080","","italic")
call <SID>X("Type","f8f8f8","","none")
call <SID>X("Typedef","e2e4e5","","none")
call <SID>X("Underlined","e2e4e5","","none")
call <SID>X("Union","e2e4e5","","none")
call <SID>X("VertSplit","5f5a60","5f5a60","italic")
